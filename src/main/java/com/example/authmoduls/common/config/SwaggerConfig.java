...
import com.example.authmoduls.common.decorator.ExtendRelativePathProvider;
...
public class SwaggerConfig {
    ...
    public Docket eventApi() {
        return new Docket(
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.example.authmoduls.auth.controller"))
