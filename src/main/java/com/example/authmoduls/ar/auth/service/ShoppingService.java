...
public interface ShoppingService {
    ShoppingResponse addOrUpdateShopping(ShoppingAddRequest shoppingAddRequest, Role role,String id) throws InvocationTargetException, IllegalAccessException;
